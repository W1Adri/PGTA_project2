...
data_021 = [
    ...
    # ["46", "-",        "Not Used",                                                "-"],
    # ["47", "-",        "Not Used",                                                "-"],
    [48, "I021/RE",       "Reserved Expansion Field",                                "1+1+"],
    [49, "I021/SP",       "Special Purpose Field",                                   "1+1+"],
    # ["FX", "n.a.",     "Field extension indicator",                               "n.a."],
]
...
data_048 = [
    ...
    [27, "I048/SP", "Special Purpose Field",                                       "1+1+"],
    [28, "I048/RE", "Reserved Expansion Field",                                    "1+1+"],
    # ["FX", "n.a.",         "Field Extension Indicator",                                   "n.a."],
]
